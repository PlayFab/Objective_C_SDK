...
-(void) GetPlayFabIDsFromNintendoServiceAccountIds:(ClientGetPlayFabIDsFromNintendoServiceAccountIdsRequest*)request success:(GetPlayFabIDsFromNintendoServiceAccountIdsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientGetPlayFabIDsFromNintendoServiceAccountIdsRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientGetPlayFabIDsFromNintendoServiceAccountIdsResult *model = [[ClientGetPlayFabIDsFromNintendoServiceAccountIdsResult new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/GetPlayFabIDsFromNintendoServiceAccountIds"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) LinkApple:(ClientLinkAppleRequest*)request success:(LinkAppleCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLinkAppleRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LinkApple"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) LinkNintendoServiceAccount:(ClientLinkNintendoServiceAccountRequest*)request success:(LinkNintendoServiceAccountCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    
    
    NSString *jsonString = [request JSONStringWithClass:[ClientLinkNintendoServiceAccountRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LinkNintendoServiceAccount"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) LoginWithApple:(ClientLoginWithAppleRequest*)request success:(LoginWithAppleCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLoginWithAppleRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LoginWithApple"] body:jsonString authType:nil authKey:nil];
}
...
-(void) LoginWithNintendoServiceAccount:(ClientLoginWithNintendoServiceAccountRequest*)request success:(LoginWithNintendoServiceAccountCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    if ([PlayFabSettings.TitleId length] > 0)
        request.TitleId = PlayFabSettings.TitleId;

    
    NSString *jsonString = [request JSONStringWithClass:[ClientLoginWithNintendoServiceAccountRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LoginWithNintendoServiceAccount"] body:jsonString authType:nil authKey:nil];
}
...
-(void) UnlinkApple:(ClientUnlinkAppleRequest*)request success:(UnlinkAppleCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/UnlinkApple"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) UnlinkNintendoServiceAccount:(ClientUnlinkNintendoServiceAccountRequest*)request success:(UnlinkNintendoServiceAccountCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/UnlinkNintendoServiceAccount"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) UnlinkTwitch:(ClientUnlinkTwitchAccountRequest*)request success:(UnlinkTwitchCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientUnlinkTwitchAccountRequest class]];
