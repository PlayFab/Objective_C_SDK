...
typedef void(^LinkNintendoServiceAccountCallback)(ClientEmptyResult* result, NSObject* userData);
...
typedef void(^LoginWithNintendoServiceAccountCallback)(ClientLoginResult* result, NSObject* userData);
...
typedef void(^UnlinkNintendoServiceAccountCallback)(ClientEmptyResponse* result, NSObject* userData);
